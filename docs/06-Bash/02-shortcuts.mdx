...
In Emacs <BlueHighlight>killing</BlueHighlight> is synonymous with cutting, and <BlueHighlight>yanking</BlueHighlight> is synonymous with pasting. Killing something deletes it and sends it to clipboard for pasting.
...
This is also a useful for <GreenHighlight>regenerating the renderer in Claude Code</GreenHighlight>. Think of it as a refresh for CC.
...
## General Shortcuts to Know About

This section is devoted to a lot of useful shortcuts I have learned, all of which make life a lot easier. Not limited to terminal.

### VSCode Terminal Toggle

Use `Ctrl + ~` to toggle the terminal in VSCode instead of constantly clicking on `View` then `Terminal`.
