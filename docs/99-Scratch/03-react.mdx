...
Instead of `addEventListener` in components (see [here](../05-Programming/03-Javascript.mdx#addeventlistener)), React provides <BlueHighlight>synthetic event handlers</BlueHighlight> like such:
