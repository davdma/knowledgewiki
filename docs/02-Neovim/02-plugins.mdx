...
The most convenient way if you have recently opened the file you want to navigate to is to use `<leader>s.` - this will open up a list of your recent files, and pressing `Enter` will switch to that file. However, if you have not opened the file before, you will need to use a different plugin.
